...
function Sidebar({ role, isOpen = true }) {
  ...
  const facultyItems = [
    ...
    { to: "/faculty/documents", icon: FileText, label: "Document Review" },
    { to: "/faculty/payments", icon: CreditCard, label: "Payment Validation" },
    { to: "/faculty/students", icon: Users, label: "Student Details" },
    { to: "/faculty/notifications", icon: Bell, label: "Notifications" },
  ];

  const studentItems = [
    { to: "/student", icon: LayoutDashboard, label: "Status" },
    { to: "/student/documents", icon: FileText, label: "Documents" },
    { to: "/student/payments", icon: CreditCard, label: "Payments" },
    { to: "/student/notifications", icon: Bell, label: "Notifications" },
    { to: "/student/support", icon: HelpCircle, label: "Help" },
  ];
